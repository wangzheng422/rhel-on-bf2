...
dnf install -y openvswitch2.13-2.13.0-67.el8fdp.aarch64.rpm python3-openvswitch2.13-2.13.0-67.el8fdp.aarch64.rpm openvswitch2.13-devel-2.13.0-67.el8fdp.aarch64.rpm openvswitch-selinux-extra-policy-1.0-23.el8fdp.noarch.rpm
